...
void AC_AttitudeControl_Multi::rate_controller_run()
{
    ...
    _motors.set_yaw_ff(get_rate_yaw_pid().get_ff()*_feedforward_scalar);    //目前的前馈为零
